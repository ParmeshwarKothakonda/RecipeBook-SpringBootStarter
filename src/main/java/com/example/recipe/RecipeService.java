...
public class RecipeService implements RecipeRepository {
        ...
        @Override 
        public ArrayList<Recipe> getRecipes(){  //GET ALL METHOD
        ...
        public Recipe addRecipe(Recipe recipe){ //POST METHOD
        ...
        public Recipe getRecipeById(int recipeId){ //GET SPECIFIC METHOD
        ...
        public void deleteRecipe(int recipeId){ //DELETE METHOD
                Recipe recipe = recipeBook.get(recipeId);
        ...
        public Recipe updateRecipe(int recipeId, Recipe recipe){ //UPDATE METHOD
